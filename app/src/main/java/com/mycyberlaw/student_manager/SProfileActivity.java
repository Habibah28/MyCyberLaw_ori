...
public class SProfileActivity extends AppCompatActivity implements View.OnClickListener {

    TextView textViewName;
    TextView textViewMatricNum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewMatricNum = (TextView) findViewById(R.id.textViewMatricNum);
        ...
        matricNum = sharedPreferences.getString(Config.MATRICNUM_SHARED_PREF,"Not Available");
        if (!matricNum.isEmpty() || !matricNum.equals("Not Available")) {
            //Showing the current logged in email to textview
            textViewMatricNum.setText(matricNum);

            getProfile(Config.GET_PROFILE);
        } else {
        ...
        alertDialogBuilder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Intent intent = new Intent(SProfileActivity.this, MainActivity.class);
    ...
    private void getProfile(String url) {
        class GetProfile extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(SProfileActivity.this, null,"Please Wait...",true,true);
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    URL url = new URL(uri+"?matricNum="+matricNum);
                    Log.d("debug", "student profile "+url);
    ...
    private void saveProfile() {
        ...
        final ProgressDialog loading = ProgressDialog.show(SProfileActivity.this, null, "Please Wait...", true, true);
        ...
        if (!pass1.equals(pass2) || pass1.isEmpty() || pass2.isEmpty() || email.isEmpty()) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.SAVE_PROFILE,
                ...
                protected Map<String,String> getParams(){
                    ...
                    params.put(Config.KEY_MATRIC_NO, matricNum);
                    return params;
                }
