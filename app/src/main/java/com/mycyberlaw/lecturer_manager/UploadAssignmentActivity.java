...
public class UploadAssignmentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void uploadMultipart() {
        ...
        if (filename.isEmpty() || target.isEmpty()) {
            editTextFilename.setError("Required");
            editTextTarget.setError("Required");
        } else {
            ...
            try {
                ...
                new MultipartUploadRequest(this, uploadId, Config.UPLOAD_ASSIGN_URL)
                        ...
                        .setDelegate(new UploadStatusDelegate() {
                            ...
                            public void onProgress(UploadInfo uploadInfo) {
                                loading[0] = ProgressDialog.show(UploadAssignmentActivity.this, null, "Uploading at " + Placeholders.UPLOAD_RATE + " (" + Placeholders.PROGRESS + ")", true, true);
                            }

                            @Override
                            public void onError(UploadInfo uploadInfo, Exception exception) {
                                loading[0].dismiss();
                                new MaterialDialog.Builder(UploadAssignmentActivity.this)
